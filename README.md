...
* [Git репозиторий](https://gitlab.com/Protosuv/diplom-nginx-app/-/blob/main/Dockerfile) с тестовым приложением и Dockerfile.  
* [Dockerhub регистр](https://hub.docker.com/repository/docker/protosuv/diplom-nginx-app) с собранным docker image.
