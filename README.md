...
* [Git репозиторий](https://gitlab.com/Protosuv/diplom-nginx-app/-/blob/main/Dockerfile "Git репозиторий") с тестовым приложением и Dockerfile.  
...
```
Видно, что существует сервис Grafana на нужном порту. 
...
* [Http доступ](http://52.205.240.237:30000/login "Http доступ") к web интерфейсу grafana. (вход осуществляется под учётными данными **admin:admin**)
* Дашборды в grafana отображающие состояние Kubernetes кластера.
* [Http доступ](http://52.205.240.237:30001 "Http доступ") к тестовому приложению.
